...
* [ADR-007: 1ターン中のカード使用枚数はリソースとクールタイムで制限する（希少MODによる無限ループを許可）](GameDesign/ADR-007-multiple-card-plays-per-turn-by-resource.md)
...
* [ADR-013: Outpostを遠征間の恒久拠点とし、施設ごとに成長判断を分ける](GameDesign/ADR-013-outpost-facilities-and-workshop-flow.md)
