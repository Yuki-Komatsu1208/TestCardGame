...
* [ADR-002: カードレベル・マナコスト・クールタイムを独立した調整軸にする](GameDesign/ADR-002-independent-card-level-cost-cooldown.md)
* [ADR-003: 一般戦闘報酬はMOD中心の三択強化にする](GameDesign/ADR-003-battle-reward-design.md)
